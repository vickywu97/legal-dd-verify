...
> 本仓库是**一个完整、可运行的工作示例（reference implementation）**：它绑定了一份我**从零原创**的虚构演示数据室（"霁川智链科技股份有限公司"）与一份通用核查清单。全部主体、人员、合同、账号、地址与交易数据均为合成信息，与任何真实主体、真实项目或第三方题库无关。
...
`materials/` 下是一份我**独立撰写**的虚构数据室，主体为"霁川智链科技股份有限公司"（CEO 陆屿、CTO 柯岚、投资人澂江创业投资有限公司等），覆盖主体资格、股权与治理、重大合同与融资、知识产权与 IT、劳动人事、数据合规与业务资质、争议债务与保险、物业 8 大领域共 29 份资料。
...
- **CTO 劳动合同未签署**：核心人员柯岚的劳动合同及 IP 协议为未签署稿。
...
# 2) 用默认演示数据室（霁川智链）跑通整条链路，并运行独立校验器
...
|---|---|---|---|
| `cloudlink`（默认） | 霁川智链科技股份有限公司 | 企业 SaaS / 数据合规 | 股权比例 8%↔10%、新加坡节点数据跨境、供应商丙索赔漏列 |
| `hanwei_semi` | 琢微半导体（苏州）有限公司 | 半导体 / AI 芯片 | 股权比例 12%↔15%、香港节点数据跨境、砚川科技索赔漏列 |
